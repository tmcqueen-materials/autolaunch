# Based on https://github.com/jupyterhub/nbgitpuller/blob/main/nbgitpuller/_compat.py
import warnings

_JupyterHandler = None

def get_base_handler(app=None):
    """Get the base JupyterHandler class to use. Inferred from app class (either jupyter_server or notebook app)
    """
